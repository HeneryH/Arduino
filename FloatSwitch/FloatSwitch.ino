...
// Float sensor connected to D3 (INT1)
// When FALL happens on D3, the sketch transmits a "MOTION" msg to receiver Moteino and goes back to sleep
...
//****************************************************************************************************************
#define NODEID        66    //unique for each node on same network
